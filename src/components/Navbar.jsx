        ...
        <ul
          className={
            isNavOpen
              ...
              : "hidden w-full h-full md:relative md:flex md:space-x-10 lg:space-x-14 text-base md:bottom-6 lg:right-0 md:pr-20 lg:pr-36 flex-1 justify-end p-10 bg-transparent backdrop-blur-[6px] text-white ml-16 md:ml-0 lg:ml-16 z-20"
          }
        >
